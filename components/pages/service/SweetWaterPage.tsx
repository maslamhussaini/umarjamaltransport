...
interface SweetWaterPageProps {
  onNavigate: (page: string) => void;
  onServiceSelect: (service: string) => void;
}

const SweetWaterPage: React.FC<SweetWaterPageProps> = ({ onNavigate, onServiceSelect }) => {
  useEffect(() => {
