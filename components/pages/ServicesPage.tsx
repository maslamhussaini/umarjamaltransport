            ...
            {services.map((service, index) => {
              ...
              return (
                <div 
                  ...
                  className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 border border-slate-100 group p-6 fade-in cursor-pointer"
